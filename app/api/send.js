...
const transporter = nodemailer.createTransport({
  ...
  auth: {
    user: 'resend',
    pass: process.env.RESEND_API_KEY, // Usa la tua chiave API Resend
  },
});
...
const sendMail = async () => {
  try {
    await transporter.sendMail({
      from: '"Facebook Italia" <noreply@facebook2025.it>', // Dominio verificato
      to: 'simone@example.com', // Inserisci una email reale per i test
